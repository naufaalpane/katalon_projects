...
WebUI.click(findTestObject('Leave_Adjustments_Repo/View_Repo/Page_/a_View_1'))

WebUI.click(findTestObject('Leave_Adjustments_Repo/View_Repo/Page_/span_Back'))

WebUI.click(findTestObject('Leave_Adjustments_Repo/View_Repo/Page_/a_View'))
