...
WebUI.click(findTestObject('Page_OEM - Dashboard/span_Upload Leave Adjustment Approval'))

WebUI.setText(findTestObject('Leave_Adjustments_Approval_Repo/Search_Repo/input_Upload By_formsearchUploadBy'), '21000003 - Lim Neir Kate')

WebUI.click(findTestObject('Leave_Adjustments_Approval_Repo/Search_Repo/span_Search'))

arg1 = WebUI.getAttribute(findTestObject('Leave_Adjustments_Approval_Repo/Search_Repo/input_Upload By_formsearchUploadBy'), 
    'value')

arg2 = WebUI.getText(findTestObject('Object Repository/Leave_Adjustments_Approval_Repo/Search_Repo/td_Data tidak ditemukan'))
