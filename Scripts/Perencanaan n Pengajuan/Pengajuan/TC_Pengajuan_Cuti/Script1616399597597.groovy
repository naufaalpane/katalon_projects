...
WebUI.click(findTestObject('Page_OEM - Dashboard/a_Pengajuan Cuti'))

WebUI.click(findTestObject('Leave_Pengajuan_Repo/span_Add'))

WebUI.click(findTestObject('Leave_Pengajuan_Repo/span_Add_in'))

WebUI.click(findTestObject('Leave_Pengajuan_Repo/yes/input_Date From_formdateFrom_input'))

WebUI.click(findTestObject('Leave_Perencanaan_Cuti_Repo/new/a_15'))

WebUI.click(findTestObject('Leave_Pengajuan_Repo/yes/input_Date To_formdateTo_input'))

WebUI.click(findTestObject('Leave_Perencanaan_Cuti_Repo/new/a_17'))

WebUI.click(findTestObject('Leave_Pengajuan_Repo/yes/span_Search'))

WebUI.click(findTestObject('Leave_Pengajuan_Repo/a_Choose'))

WebUI.click(findTestObject('Leave_Pengajuan_Repo/span_Submit'))

WebUI.click(findTestObject('Leave_Pengajuan_Repo/span_Yes'))
