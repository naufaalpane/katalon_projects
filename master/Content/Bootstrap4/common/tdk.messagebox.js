        ...
        //alert(text);
            ...
            if ($("body #messagebox" + confirmId).length === 0) {
              $("body").append("<div id=\"messagebox" + confirmId + "\" class=\"modal fade bs-example-modal-lg\" data-backdrop=\"static\" data-keyboard=\"false\">" +
                ...
                "<h4 class=\"modal-title\" style=\"padding-top: 2px;\" id=\"messagebox-title\"></h4>" +
                "<button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">" +
                "<span aria-hidden=\"true\" id=\"message-img\"></span>" +
                "</button></div>" +
                "<div class=\"modal-body\"><div class=\"row\" style=\"overflow-y: auto; max-height: 515px; margin-bottom: -15px;\" >" +
                "<p id=\"messagebox-text\" style=\"font-size: 12.5px;\"></p></div></div>" +
