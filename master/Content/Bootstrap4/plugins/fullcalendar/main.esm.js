...
var extendStatGPPSU = function(d, b) {
    extendStatGPPSU = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
    return extendStatGPPSU(d, b);
};
    ...
    switch (action.type) {
        ...
        case 'CHANGE_TIMEZONE':
            return fetchSourcesByIds(eventSources, action.sourceIds ?
                ...
                excludeStatGPPSUources(eventSources, calendar), dateProfile ? dateProfile.activeRange : null, calendar);
        case 'RECEIVE_EVENTS':
...
function excludeStatGPPSUources(eventSources, calendar) {
