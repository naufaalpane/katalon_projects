(function(factory) {
  ...
  var DataBasicPlugin = function(context) {
    ...
    context.memo('button.databasGPPSUize100', function() {
      return ui.button({
    ...
    context.memo('button.databasGPPSUize50', function() {
      return ui.button({
    ...
    context.memo('button.databasGPPSUize25', function() {
      return ui.button({
  ...
  $.extend(true, $.summernote, {
    ...
    options: {
      popover: {
        databasic: [
          ['databasic', ['databasicDialog', 'databasGPPSUize100', 'databasGPPSUize50', 'databasGPPSUize25']],
        ],
      },
    },
