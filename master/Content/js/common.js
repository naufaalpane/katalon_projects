...
function popUpProgressShow() {
    $.blockUI({
        message: '</br><div style="font-weight: bold;font-size: 110%;font-family: Arial; color: #2D7EC5;"><h5>Loading</h5></div><div style="font-weight: bold;font-size: 110%;font-family: Arial; color: #2D7EC5;"><h5>Please wait...</h5></div></br><img src="' + gRootPath + 'Content/Images/loading.gif" /></br></br>',
        css: {
            padding: 0,
            margin: 0,
            width: '22%',
...
function showSuccessMesgGrowl(mesg) {
    $.bootstrapGrowl("<center>" + mesg + "</center>", {
        type: 'success',
        allow_dismiss: true,
        align: 'center',
        width: 350,
