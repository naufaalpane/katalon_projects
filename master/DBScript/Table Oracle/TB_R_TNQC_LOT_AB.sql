CREATE TABLE GPPS_U_DEV.TB_R_TNQC_LOT_AB
(
...
CREATE UNIQUE INDEX GPPS_U_DEV.PK_TB_R_TNQC_LOT_AB ON GPPS_U_DEV.TB_R_TNQC_LOT_AB
(	VER					,
    COMPANY_CD		  ,
    PLANT_CD	,
    DOCK_CD			  ,
...
ALTER TABLE GPPS_U_DEV.TB_R_TNQC_LOT_AB ADD (
  CONSTRAINT PK_TB_R_TNQC_LOT_AB
  PRIMARY KEY
  (VER					,
    COMPANY_CD		  ,
    PLANT_CD	,
  ...
  USING INDEX GPPS_U_DEV.PK_TB_R_TNQC_LOT_AB
  ENABLE VALIDATE);