CREATE TABLE GPPS_U_DEV.TB_R_TNQC_LOT_ABF
(
...
CREATE UNIQUE INDEX GPPS_U_DEV.PK_TB_R_TNQC_LOT_ABF ON GPPS_U_DEV.TB_R_TNQC_LOT_ABF
(	VER					,
    COMPANY_CD        	,
    PLANT_CD         	,
    DOCK_CD           	,
...
ALTER TABLE GPPS_U_DEV.TB_R_TNQC_LOT_ABF ADD (
  CONSTRAINT PK_TB_R_TNQC_LOT_ABF
  PRIMARY KEY
  (	VER					,
    COMPANY_CD        	,
    PLANT_CD         	,
  ...
  USING INDEX GPPS_U_DEV.PK_TB_R_TNQC_LOT_ABF
  ENABLE VALIDATE);
