CREATE TABLE GPPS_U_DEV.TB_R_TNQC_LOT_FO
(
...
CREATE UNIQUE INDEX GPPS_U_DEV.PK_TB_R_TNQC_LOT_FO ON GPPS_U_DEV.TB_R_TNQC_LOT_FO
(	VER					,
    COMPANY_CD        	,
    PLANT_CD         	,
    DOCK_CD           	,
...
ALTER TABLE GPPS_U_DEV.TB_R_TNQC_LOT_FO ADD (
  CONSTRAINT PK_TB_R_TNQC_LOT_FO
  PRIMARY KEY
  (	VER					,
    COMPANY_CD        	,
    PLANT_CD         	,
  ...
  USING INDEX GPPS_U_DEV.PK_TB_R_TNQC_LOT_FO
  ENABLE VALIDATE);
