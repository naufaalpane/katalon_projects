CREATE TABLE GPPS_U_DEV.TB_R_TNQC_RESULT_ABF
(
...
RATION                  VARCHAR2(3 BYTE)            NOT NULL,
...
CREATE UNIQUE INDEX GPPS_U_DEV.PK_TB_R_TNQC_RESULT_ABF ON GPPS_U_DEV.TB_R_TNQC_RESULT_ABF
(	VER					,
    COMPANY_CD        	,
    PLANT_CD         	,
    DOCK_CD           	,
...
ALTER TABLE GPPS_U_DEV.TB_R_TNQC_RESULT_ABF ADD (
  CONSTRAINT PK_TB_R_TNQC_RESULT_ABF
  PRIMARY KEY
  (	VER					,
    COMPANY_CD        	,
    PLANT_CD         	,
  ...
  USING INDEX GPPS_U_DEV.PK_TB_R_TNQC_RESULT_ABF
  ENABLE VALIDATE);