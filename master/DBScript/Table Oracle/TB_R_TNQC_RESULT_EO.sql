CREATE TABLE GPPS_U_DEV.TB_R_TNQC_RESULT_EO
(
...
CREATE UNIQUE INDEX GPPS_U_DEV.PK_TB_R_TNQC_RESULT_EO ON GPPS_U_DEV.TB_R_TNQC_RESULT_EO
(	VER					,
    COMPANY_CD        	,
    PLANT_CD         	,
    DOCK_CD           	,
...
ALTER TABLE GPPS_U_DEV.TB_R_TNQC_RESULT_EO ADD (
  CONSTRAINT PK_TB_R_TNQC_RESULT_EO
  PRIMARY KEY
  (	VER					,
    COMPANY_CD        	,
    PLANT_CD         	,
  ...
  USING INDEX GPPS_U_DEV.PK_TB_R_TNQC_RESULT_EO
  ENABLE VALIDATE);
