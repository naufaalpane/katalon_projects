...
{
    public class ProductionPlanPrintInstructionsRepository : GPPSU.Commons.Repositories.BaseRepo
    {
        private static readonly string SHEET_NAME_DESTINATION_MASTER = "K/M Prod Plan Creation Screen";

        #region singleton
        private static ProductionPlanPrintInstructionsRepository instance = null;
        public static ProductionPlanPrintInstructionsRepository Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new ProductionPlanPrintInstructionsRepository();
                }
                return instance;
            }
        }
        ...
        #region Search & Count
        public IList<ProductionPlanPrintInstructions> Search(IDBContext db, ProductionPlanPrintInstructions data)

        {
            ...
            IList<ProductionPlanPrintInstructions> result = db.Fetch<ProductionPlanPrintInstructions>("ProductionPlanPrintInstructions/ProductionPlanPrintInstructions_Search", args);
            return result;
        }
        ...
        public RepoResult Print(ProductionPlanPrintInstructions param, string userid)
        {
            ...
            int result = db.Execute("ProductionPlanPrintInstructions/ProductionPlanPrintInstructions_Print", args);
